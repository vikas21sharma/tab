                           ...
                           <form class="form-horizontal" action="add_student.php" method="post">
                               <fieldset>
                                   ...
                                   <div class="form-group">
                                       <label class="col-md-3 control-label" for="name">Student Name</label>
                                       <div class="col-md-9">
                                           <input id="name" name="student_name" type="text" placeholder="student same" class="form-control"></div>
                                   </div>
                                   <!-- Email input-->
                                   <div class="form-group">
                                   ...
                                   <div class="form-group">
                                       ...
                                       <div class="col-md-9">
                                           <input id="email" name="password" type="text" placeholder="password" class="form-control"></div>
                                   </div>

                                   <div class="form-group">
                                       <label class="col-md-3 control-label" for="email">Address</label>
                                       <div class="col-md-9">
                                           <input id="email" name="address" type="text" placeholder="address" class="form-control"></div>
                                   </div>

                                   <div class="form-group">
                                       <label class="col-md-3 control-label" for="email">Phone</label>
                                       <div class="col-md-9">
                                           <input id="email" name="phone" type="tel" placeholder="phone" class="form-control"></div>
                                   </div>
                                   ...
                                   <div class="form-group">
                                       <div class="col-md-12 text-center">
                                           <button type="submit" name="submit210" class="btn btn-responsive btn-primary btn-sm">Submit</button>
                                       </div>
                                   </div>
                               </fieldset>
                           </form>
