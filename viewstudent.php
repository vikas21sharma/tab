...
$result=mysqli_query($con,"select * FROM clms_student");
                ...
                <div class="row">
                    <div class="panel panel-primary ">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <i class="livicon" data-name="user" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Student List
                            </h4>
                        </div>
                        <br />
				  ...
				  ?>
                                    <tr>
                                      ...
                                      <td style="text-align:center;"><?php echo $row['connected_at'];?></td>
                                      <td style="text-align:center;"><?php echo $row['logout_time'];?></td>

                                      <td>
                                          <div class="col-lg-2 col-md-3 col-sm-3 col-xs-6 text-left" style="margin:10px">
                                            <a href="edit_data2.php?id=<?php echo $row['id'];?>">
                                            ...
                                            <div class="col-lg-2 col-md-3 col-sm-3 col-xs-6 text-center" style="margin:10px">
                                             <a href="delete2.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this item?');">
                                                <i class="livicon" data-name="trash" data-size="40" data-c="#f56954" data-hc="#f56954" data-loop="true" title="delete user"></i>
                                              </a>
