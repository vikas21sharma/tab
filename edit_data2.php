...
$e=$_REQUEST['id'];
$sql_query1="select id, username, email, password, address, phone FROM clms_student where id='".$e."'";
               ...
               <!-- <div class="col-md-6"> -->
                   ...
                   <div class="panel panel-primary" id="hidepanel1" style="width:800px margin: auto">
                       ...
                       <div class="panel-body" >
                           <form class="form-horizontal" action="edit_data3.php?id=<?php echo $row1[0];?>" method="post">
                               <fieldset>
                                   <!-- Name input-->
                                   <div class="form-group">
                                       <label class="col-md-3 control-label" for="name">Username</label>
                                       <div class="col-md-9">
                                           <input id="name" name="username" type="text" class="form-control" value="<?php echo $row1[1]; ?>"></div>
                                   </div>
                                   <!-- Email input-->
                                   <div class="form-group">
                                       <label class="col-md-3 control-label" for="email">Email</label>
                                       <div class="col-md-9">
                                           <input id="email" name="email" type="text" class="form-control" value="<?php echo $row1[2];?>"></div>
                                   </div>

                                   <div class="form-group">
                                       <label class="col-md-3 control-label" for="email">Password</label>
                                       <div class="col-md-9">
                                           <input id="email" name="password" type="text" class="form-control" value="<?php echo $row1[3];?>"></div>
                                   </div>

                                   <div class="form-group">
                                       <label class="col-md-3 control-label" for="email">Address</label>
                                       <div class="col-md-9">
                                           <input id="email" name="address" type="text" class="form-control" value="<?php echo $row1[4];?>"></div>
                                   </div>

                                   <div class="form-group">
                                       <label class="col-md-3 control-label" for="email">phone</label>
                                       <div class="col-md-9">
                                           <input id="email" name="phone" type="text"  class="form-control" value="<?php echo $row1[5]; ?>"></div>
                                   </div>
                                   <!-- Form actions -->
                                   <div class="form-group">
                                       <div class="col-md-12 text-center">
                                           <button type="submit" name="submit222" class="btn btn-responsive btn-primary btn-sm">Update</button>
