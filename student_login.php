...
$q = $_POST['select12'];
$sql_query1="select id, computer_name FROM computer_info where id='".$q."'";
                ...
                <div id="container_demo">
                    ...
                    <div id="wrapper">
                        ...
                        <div id="login" class="animate form">
                            <form action="text1.php?id=<?php echo $row1[0];?>" method="post">
                                <h3 class="black_bg">
                                    <p>CLMS</p>
                                    </h3>
                                    <br>
...
<?php }?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group striped-col">
                                            ...
                                            <p class="form-control-static" style="text-align:left;font-size:30px;"><strong><?php echo $row1[1]; ?></strong></p>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <textarea placeholder="Write something here..." class="span3 form-control scroll pd resize_vertical " data-autogrow rows="3" cols="80" name="text1" ></textarea>
                                    </div>
                                    <!-- /.input group -->
                                </div>
                                ...
                                <p class="login button">
                                    <input type="submit" value="submit" class="btn btn-success" name="submit31" />
                                </p>
                                <p style="text-align:center;"> or </p>
                                <a href="logout.php"> <p class="login button">
                                  <input type="button" value="logout" class="btn btn-success" name="submit114" />
                              </p></a>
                                <!--<p class="change_link">
